  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-xl-10 col-lg-12 col-md-9"><br><br>
          ...
          <h2 style="color: white" class="Nunito"><?php echo $settings_app[0]->setting_appname?></h2>
        ...
        <hr>
                  ...
                  <?php echo form_close(); ?>
                  <hr>
                  <center style="font-size: 12px;">Copyright @2021, <?php echo $settings_app[0]->setting_origin_app;?><br>Support By <a href="#" class="text-info" >Gagas Aliansi Cakrawala</a></center>
                  <!-- <div class="text-center">
